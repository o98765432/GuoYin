<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="DtCms.Web.Admin.ArticlePictures.Add" ValidateRequest="false" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx?parentId=<%=Request.QueryString["ParentId"]%>&kindId=<%=Request.QueryString["kindId"] %>">返回列表</a></span><b>您当前的位置：首页 &gt; 资讯管理 &gt; 发布资讯</b>
    </div>
