<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DtCms.Web.Admin.Consultant.List" %>
  ...
  <div class="navigation"> <span class="back"><a href="">返回列表</a></span><b>您当前的位置：首页 &gt; 资讯管理 &gt; 编辑资讯</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center"><a href="Edit.aspx?id=<%#Eval("Id") %>"><%#Eval("Company")%></a></td>
