...
namespace DtCms.Web.Admin.Consultant
{
    public partial class List : DtCms.Web.UI.ManagePage
    {
        ...
        public int page;                        //当前页
        public int pagesize = 50;                    //设置每页显示的大小
        ...
        protected BLL.Consultant con = new BLL.Consultant();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                this.RptBind("Id>0 and typeId = 1 ");
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            this.rptList.DataBind();
            Response.Write("<script type='text/javascript'>alert('删除成功');location.href='List.aspx?" + CombUrlTxt(this.classId, this.keywords, this.property) + "page=0&classid=" + this.classId + "'</script>");
            Response.End();
        }
