<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DtCms.Web.Admin.Downloads.Edit" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
            ...
            editor = K.create('#txtContent',
        {
          ...
          <%=DtCms.BLL.Chenadd.returnAllTable(4, classid)%>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
         ...
         <tr style="display:none">
            <td width="15%" align="right">链接：</td>
            <td width="85%">
            <asp:TextBox ID="txtSubTitle" runat="server" CssClass="input w380" 
            maxlength="250" minlength="3" HintTitle="发布的文件副标题" HintInfo="控制在100个字数内，标题文本尽量不要太长。"></asp:TextBox>
            </td>
        </tr>
         <%=DtCms.BLL.Chenadd.returnAllTable(4, classid, Id)%>
        <tr>
            <td align="right">所属栏目：</td>
            <td><asp:DropDownList id="ddlClassId" CssClass=" required" runat="server"></asp:DropDownList></td>
        </tr>
        <tr  <%if(channelmodel.width==0&&channelmodel.height==0) {%>style="display:none"<%} %>>
