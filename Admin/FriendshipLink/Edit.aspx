<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DtCms.Web.Admin.FriendshipLink.Edit" %>
...
<body style="padding:10px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td width="85%">
            <asp:TextBox ID="txtTitles" runat="server" CssClass="input w380 required" 
  ...
  &nbsp;<asp:Button ID="btnSave" runat="server" Text="更新" 
