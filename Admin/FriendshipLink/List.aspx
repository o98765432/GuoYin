<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DtCms.Web.Admin.FriendshipLink.List" %>
      ...
      <%if(Request.QueryString["showtype"]=="1"){ %>
       ...
       <%} %>
        ...
        function changePaixuAndIslock() {
            ...
            window.document.location.href = "../Handler/changeFriendShipPaiXuAndIsLock.ashx?paixuInfo=" + proInfo + "&isLockInfo=" + isLockInfo + "&classId=" + classId + "&vers=" + ver + "";
...
<body style="padding:10px;">
    ...
    <%if(addflag == true){%>
    <span class="add"><a href="Edit.aspx?classid=<%=this.classId %>">增加友情链接</a></span>
    <%} %>
