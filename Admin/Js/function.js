...
//================上传文件JS函数开始，需和jquery.form.js一起使用===============
//单个文件上传
function SingleUpload2(repath, uppath, iswater) {

    var submitUrl = "../../Tools/SingleUpload1.ashx?ReFilePath=" + repath + "&UpFilePath=" + uppath;
    //判断是否打水印
    if (arguments.length == 3) {
        submitUrl = "../../Tools/SingleUpload1.ashx?ReFilePath=" + repath + "&UpFilePath=" + uppath + "&IsWater=" + iswater;
    }
    //开始提交
    $("#form1").ajaxSubmit({
        beforeSubmit: function (formData, jqForm, options) {
