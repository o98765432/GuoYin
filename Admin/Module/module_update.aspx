<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_update.aspx.cs" Inherits="WEB.manage.Module.module_update" %>
...
<body style="padding:10px;">
	<form id="form1" runat="server">
      ...
      <span class="back"><a href="module.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 模块管理 &gt; 修改模块</b>
    </div>
	...
	<div>
		<table width="96%" border="0" cellpadding="0" cellspacing="0" class="msgtable">
						...
						<tr>
                            <th colspan="2" align="left">修改模块</th>
                        </tr>
						<tr>
							<td class="c_tdleft">
								选择栏目:
            ...
            maxlength="100" minlength="0" HintTitle="网站标题名称" HintInfo="控制在100个字符内，标题文本尽量不要太长。"></asp:TextBox>
  ...
  <asp:Button ID="btnAdd" runat="server" Text="确认保存" CssClass="submit" onclick="btnUpdate_Click" 
        />
