<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FieldEdit.aspx.cs" Inherits="DtCms.Web.Admin.Pictures.FieldEdit" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
       ...
       <tr>
        ...
        <td width="75%">
          <asp:DropDownList id="ddlFieldType" CssClass="required" runat="server">
              ...
              <asp:ListItem Value="LongText">长标题文本</asp:ListItem>
              <asp:ListItem Value="Label">图片大小标注</asp:ListItem>
       ...
       <tr>
         ...
         <td width="75%">
            <asp:TextBox ID="txtSortId" CssClass="input required number" size="10" runat="server" maxlength="9" HintTitle="扩展字段的排列顺序" HintInfo="纯数字，数字越少越向前。" Text="0"></asp:TextBox>
         </td>
       </tr>
     </table>
