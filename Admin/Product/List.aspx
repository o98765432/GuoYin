<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DtCms.Web.Admin.Product.List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function() {
		    ...
		    current_page:<%=page %>,
		    num_edge_entries:2,
		    link_to:"?classid=<%=this.classId %>&<%=CombUrlTxt(this.newsclassid, this.keywords, this.property) %>page=__id__"
           });
        });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
            ...
            <asp:ImageButton ID="ibtnViewTxt" style="display:none" runat="server" 
                ImageUrl="~/Admin/Images/txt_Show.gif" onclick="ibtnViewTxt_Click" 
                ToolTip="文字列表视图" />&nbsp;<asp:ImageButton style="display:none"  ID="ibtnViewImg" runat="server" 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center"><%# new DtCms.BLL.Channel().GetChannelTitle(Convert.ToInt32(Eval("classId")),"cn")%></td>
             ...
             <a href="../ProductKey/list.aspx?classId=<%#Eval("Id") %>&returnclassid=<%=this.classId %>&shownowid=1">合作伙伴</a>
              </td>
        <td align="center">
              ...
              <div class="left">
                ...
                <span class="btn_bg">
                  <asp:LinkButton ID="lbtnDel" runat="server" 
                    ...
                    <asp:LinkButton ID="lbtnMakeHtml" runat="server" onclick="lbtnMakeHtml_Click" 
                    >生成网页静态化</asp:LinkButton>
                </span>
                <span class="btn_bg" >
                 <asp:Button ID="Button2" runat="server"  CssClass="newcreate"  Text="生成列表页" 
                    onclick="Button2_Click" />

                 </span>
                  <span class="btn_bg" >
                 <asp:Button ID="Button3" runat="server" CssClass="newcreate"  Text="生成单页" 
                    onclick="Button3_Click" />

                 </span>
                  <span class="btn_bg" >
                 <asp:Button ID="Button4" onclick="updateInfo_Click" runat="server" CssClass="newcreate"  Text="修改" />

                 </span> 
                &nbsp;
                <span class="btn_all" onclick="location.href='../ShowChanner/List.aspx?kindId=<%=classId %>&path=Product'">管理菜单</span>
            </div>
	</div>
    </form>
</body>
