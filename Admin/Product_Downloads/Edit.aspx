<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DtCms.Web.Admin.Product_Downloads.Edit" ValidateRequest="false" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx?classId=<%=this.drpClassId %>">返回列表</a></span><b>您当前的位置：首页 &gt; 下载管理 &gt; 编辑下载</b>
    </div>
