<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DtCms.Web.Admin.Product_Downloads.List" ValidateRequest="false" %>
   ...
   <%-- <%if(addflag ==  true){%>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center"><span><a href="Edit.aspx?id=<%#Eval("Id") %>&classid=<%=this.ddlClassId.SelectedValue %>&productid=<%=this.ddlProductId.SelectedValue %>">修改</a> <a href="../Reviews/List.aspx?kindId=<%=this.kindId %>&parentId=<%#Eval("Id") %>">评论</a></span></td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
      </table>
