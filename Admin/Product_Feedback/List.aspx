<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DtCms.Web.Admin.Product_Feedback.List" %>
...
<body style="padding:10px;">
      ...
      <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlClassId" runat="server" CssClass="select" onselectedindexchanged="ddlClassId_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>&nbsp;
             <asp:DropDownList ID="ddlProductId" runat="server" CssClass="select" 
                AutoPostBack="True" onselectedindexchanged="ddlProductId_SelectedIndexChanged"></asp:DropDownList>&nbsp;
        ...
        <td width="50" align="right" style="display:none">关健字：</td>
        <td width="150" style="display:none"><asp:TextBox ID="txtKeywords" runat="server" CssClass="keyword"></asp:TextBox></td>
        <td width="60"  style="display:none" align="center"><asp:Button ID="btnSelect" runat="server" Text="查询" 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td><%# Convert.ToInt32(Eval("IsLock")) == 1 ? "<img src=\"../Images/wsh01.gif\" title=\"未审核\" />" : ""%> <a href="edit.aspx?id=<%#Eval("Id") %>"><%# DtCms.Common.Utils.DropHTML(Eval("Content").ToString(),150)%></a></td>
