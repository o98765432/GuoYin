<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="DtCms.Web.Admin.SimpleLinks.Add" ValidateRequest="false" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx?classId=<%=classid %>">返回列表</a></span><b>您当前的位置：首页 &gt; 图文链接 &gt; 增加图文链接</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">增加图文链接信息</th>
        </tr>
        <tr>
