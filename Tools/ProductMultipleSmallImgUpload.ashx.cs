...
namespace DtCms.Web.Tools
{
    ...
    /// AJAX多文件上传页
    /// </summary>
    public class ProductMultipleSmallImgUpload : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                DtCms.BLL.ProductAlbum bll = new DtCms.BLL.ProductAlbum();
                DtCms.Model.ProductAlbum model = new DtCms.Model.ProductAlbum();
